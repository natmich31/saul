...
const cargarAuto=async(idauto)=>{
    ...
    document.querySelector("#idauto").value=resultado.idauto;
...
const editarAuto=async()=>{
    var idauto=document.querySelector("#idauto").value;
